...
from roundup.entity.config_entity import DataIngestionConfig
from roundup.entity.artifact_entity import DataIngestionArtifact
from roundup.exception import RoundupException
from roundup.logger import logging
from roundup.data_access.data import RoundupData
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        try:
            ...
            dataframe = roundup_data.export_collection_as_dataframe(collection_name=
    ...
    def initiate_data_ingestion(self)->DataIngestionArtifact:
        ...
        Description : This method initiates data ingestion components of training pipeline
