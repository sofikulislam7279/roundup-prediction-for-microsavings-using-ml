...
from roundup.utils.common_utils import read_yaml_file, write_yaml_file
from roundup.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from roundup.entity.config_entity import DataValidationConfig
from roundup.constants import SCHEMA_FILE_PATH
...
class DataValidation:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        try:
            ...
            return False if (
                len(missing_categorical_columns) > 0
    ...
    def detect_dataset_drift(self, reference_df: DataFrame, current_df: DataFrame) -> bool:
        ...
        try:
            ...
            drift_metric = next(
                m["result"] for m in json_report["metrics"]
                if m["metric"] == "DatasetDriftMetric"
            )

            n_features = drift_metric["number_of_columns"]
            n_drifted_features = drift_metric["number_of_drifted_columns"]
            drift_status = drift_metric["dataset_drift"]
